...
var (
	...
	ErrorTagExist       = NewError(20010007, "标签已存在")
	...
	ErrorUpdateArticlePower = NewError(20020007, "更新文章无权限")
	ErrorDeleteArticlePower = NewError(20020008, "删除文章无权限")
	...
	ErrorAuthNoExist = NewError(20040012, "账户不存在")
)
